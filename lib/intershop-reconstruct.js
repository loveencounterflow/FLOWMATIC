(function() {
  ...
  badge = 'FLOWMATIC/intershop-reconstruct';
  ...
  for (key in ref) {
    value = ref[key];
    if ((key.match(/^(intershop|mojikura)/)) == null) {
      continue;
    }
    E[key] = value;
  }
  ...
  (async function() {    //-----------------------------------------------------------------------------------------------------------
    var filename, filetype, flush, i, len, module_nr, path, ref1, relpath, skipped;
