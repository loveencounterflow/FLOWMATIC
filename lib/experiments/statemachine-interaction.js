(function() {
  'use strict';
  var $, $async, $drain, $show, $watch, CND, DATOM, DB, PATH, RPC, SP, alert, badge, cast, debug, demo, echo, emit, freeze, help, info, isa, jr, k, log, new_datom, read_configuration, rpr, select, show, sleep, start_rpc_server, start_rpc_server_with_default_handler, type_of, types, urge, validate, warn, whisper;
