(function() {
  'use strict';
  var $, $async, $drain, $watch, CND, DATOM, DB, NET, Rpc, SP, alert, badge, cast, debug, echo, help, info, isa, jr, new_datom, rpr, select, type_of, types, urge, validate, warn, whisper;
