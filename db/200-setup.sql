...
-- cond_topic │ cond_focus │ cond_predicate │ csqt_topic │ csqt_focus │ csqt_predicate
-- -- ---------------------------------------------------------------------------------------------------------
-- create function FM.add_transition( ¶cond_topic text, ¶cond_focus text, ¶csqt_topic text, ¶csqt_focus text )
